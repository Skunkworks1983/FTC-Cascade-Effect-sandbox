...
/*
* autonomous.c proivdes autonouse control of the robot.  It should NEVER reference
* any motors or sensor directly.  Rather, it should call functions in  drivebase.c
* and maybe arm.C
*
* TO-DOs
